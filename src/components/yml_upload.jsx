...
class YMLupload extends React.Component{
    static propTypes={
    ...
    handleUpload = ()=> {
        ...
        formData.append('yml',this.state.fileList[0])
        ...
        axios({method:'post',
            ...
            .then(function (response) {
                ...
                message.success(`Upload the yml file successfully`)
            ...
            .catch(function (error) {
                message.error('Failed to upload the yml file')
                _this.setState({
                    uploading:false
                })
                console.log(error)
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Row gutter={24}>
                    <Col span={18}>
                        <p>Please click the icon to upload the _config.yml file:
                            &nbsp;
                            <Upload {...props}>
                                <a>
